...
//    public static TextField containedLettersField;
...
//
//    /**
//     * Constructor to instantiate each of the 5000 Server objects with its respective word
...
//
//    /**
//     * @return Creates an ArrayList of Server objects to be extracted later by the filtering and
//     * ActionEvent methods.
//     */
//    public static ArrayList<Server> initialize() {
//
//        // The .txt pathfile will have to be changed for every user. The .txt is included in the repo.
//        File file = new File("C:\\Users\\THEJANKMACHINE\\IdeaProjects\\demo\\CISC191-FinalProjectTemplate\\Server\\src\\main\\java\\edu\\sdccd\\cisc191\\template\\unlimited_words.txt");
//
//        try {
...
//            while (sc.hasNext()) {
//                wordList.add(new Server(sc.nextLine()));
//            }
//            sc.close();
...
//    /**
//     *
//     * @param wordList The filtered ArrayList of Server objects that previously passed through
//     *                 the exclude method.
//     * @param contains The user input of letters contained in the Worlde word.
//     * @return Returns wordList with the contained letters.
//     */
//    public static ArrayList<Server> containsLetters(ArrayList<Server> wordList, String contains) {
//        // If the TextField is empty we can't eliminate any options via this method
//        // hence all values are set to true.
//        if (contains.isEmpty()) {
//            for (int i = 0; i < wordList.size(); i++)
//                wordList.get(i).setContainedLetters(true);
//        }
//        // Based on the text length of the input it changes what filtering method we use.
//        int index = contains.length();
//
//        char[] charSearch = new char[5];
//
//        for (int i = 0; i < contains.length(); i++)
//            charSearch[i] = contains.charAt(i);
//
//        String a = Character.toString(charSearch[0]);
//        String b = Character.toString(charSearch[1]);
//        String c = Character.toString(charSearch[2]);
//        String d = Character.toString(charSearch[3]);
//        String e = Character.toString(charSearch[4]);
//
//        if (index == 1) {
//            for (int i = 0; i < wordList.size(); i++) {
//                for (int k = 0; k < charSearch.length; k++)
//                    if (wordList.get(i).getTestSring().contains(a))
//                        wordList.get(i).setContainedLetters(true);
//            }
//        }
//        else if (index == 2) {
...
//                for (int k = 0; k < charSearch.length; k++)
//                    if (wordList.get(i).getTestSring().contains(a)
//                            && wordList.get(i).getTestSring().contains(b))
//                        wordList.get(i).setContainedLetters(true);
//            }
//        }
//        else if (index == 3) {
...
//                    if (wordList.get(i).getTestSring().contains(a)
//                            && wordList.get(i).getTestSring().contains(b)
//                            && wordList.get(i).getTestSring().contains(c))
//                        wordList.get(i).setContainedLetters(true);
//            }
//        }
//        else if (index == 4) {
...
//                            && wordList.get(i).getTestSring().contains(b)
//                            && wordList.get(i).getTestSring().contains(c)
//                            && wordList.get(i).getTestSring().contains(d))
//                        wordList.get(i).setContainedLetters(true);
//            }
//        }
//        else if (index == 5) {
...
//                            && wordList.get(i).getTestSring().contains(c)
//                            && wordList.get(i).getTestSring().contains(d)
//                            && wordList.get(i).getTestSring().contains(e))
//                        wordList.get(i).setContainedLetters(true);
//            }
//        }
//        return wordList;
...
//     * @return Returns the completed filtered ArrayList of Server objects.
//     */
//    public static ArrayList<Server> positionalLetters(ArrayList<Server> wordList, String positionOne,
//                                                            String positionTwo, String positionThree,
//                                                            String positionFour, String positionFive) {
//        // The filtering of positional letters.
//        for (int i = 0; i < wordList.size(); i++) {
//            String a = Character.toString(wordList.get(i).getTestSring().charAt(0));
...
//
//            a = Character.toString(wordList.get(i).getTestSring().charAt(1));
...
//
//            a = Character.toString(wordList.get(i).getTestSring().charAt(2));
...
//
//            a = Character.toString(wordList.get(i).getTestSring().charAt(3));
...
//
//            a = Character.toString(wordList.get(i).getTestSring().charAt(4));
...
//     */
//    public static ArrayList<Server> resetValues(ArrayList<Server> wordList) {
//        // Steps through every Server object to set the values to false.
//        for (int i = 0; i < wordList.size(); i++) {
...
//
//        containedLettersField = new TextField();
//        Label containedLettersLabel = new WordleLabel("Contains");
//        HBox containedLetters = new HBox(containedLettersField, containedLettersLabel);
...
//        public ArrayList<Server> wordList = initialize();
//
//
//        @Override
...
//            containedCharacters = containedLettersField.getText().toLowerCase();
...
//            wordList = containsLetters(wordList, containedCharacters);
...
//                if (!wordList.get(b).getExcludedLetters() && wordList.get(b).getContainedLetters()
//                        && wordList.get(b).getPositionalLetter())
//                    System.out.println(wordList.get(b).getTestSring());
//            }
